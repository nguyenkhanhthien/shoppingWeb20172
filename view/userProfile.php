                    ...
                    <div class="panel-body">
                        <div class="box box-info">
                            <div class="box-body">
                                ...
                                <div class="col-sm-7 col-xs-6 " id= "userName">a</div>
                                <div class="clearfix"></div>
                                <div class="bot-border"></div>

                                <div class="col-sm-5 col-xs-6 tital " >First Name</div>
                                <div class="col-sm-7" id="firstName">a</div>
                                <div class="clearfix"></div>
                                <div class="bot-border"></div>

                                <div class="col-sm-5 col-xs-6 tital " >Last Name</div>
                                <div class="col-sm-7" id="lastName">a</div>
                                <div class="clearfix"></div>
                                <div class="bot-border"></div>

                                <div class="col-sm-5 col-xs-6 tital " >Email</div>
                                <div class="col-sm-7" id="email">a@bkav.com</div>
                                <div class="clearfix"></div>
                                <div class="bot-border"></div>

                                <div class="col-sm-5 col-xs-6 tital " >Phone Number</div>
                                <div class="col-sm-7" id="phone">1</div>
